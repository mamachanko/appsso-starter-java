...
┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [appsso-starter-java->max-appsso-starter-j...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗  Info   name: max-appsso-...(truncated), app.kubernetes.io/part-of: appsso-starter-java->app.kubernetes.io/pa...(truncated)]
